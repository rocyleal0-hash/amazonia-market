...
class CategoryWindow(tk.Toplevel):
    ...
    def _product_row(self, prod):
        ...
        tk.Button(card, text="🗑️",
                  ...
                  font=("Segoe UI", 12, "bold"),
                  relief="flat", bd=0, cursor="hand2",
                  padx=14, pady=8).pack(side="right", padx=12, pady=10)
